...
We ask you to submit code, a UML diagram, and a video in a directory named YOURCCID-MyMovieWishlist (e.g., hktang-MyMovieWishlist). This directory should contain:
